...
This is my test version for demonstration CAN Bus use only by John Holmes
  ...
  - Pins 4,5,6,7,8,9,A0,A1,A2,A3 are used for input or output
  - Pins A4,A5 servos
...
#define MODEL "AVR2Servo10IO"   // The model of the board
...
#ifdef NOCAN
  uint8_t iopin[NUM_IO] = {4,5,6,7,8,9,A0,A1,A2,A3}; // use pin 13 LED for demo purposes with direct cnx
#else
  uint8_t iopin[NUM_IO] = {4,5,6,7,8,9,A0,A1,A2,A3};  // use free pins on MERG CAN board
#endif
...
{ 
  ...
  NODECONFIG.put(EEADDR(nodeDesc), ESTRING("2Servos10IO"));
