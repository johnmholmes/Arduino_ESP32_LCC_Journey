...
/*
This is my test version for demonstration CAN Bus use only by John Holmes 6 Servo 6 I/O
  ...
  - Pins 3,4,5,6,7,8 are used for input or output
  - Pins A0,A1,A2,A3,A4,A5 servos
...
extern "C" {
    ...
    const EIDTab eidtab[NUM_EVENT] PROGMEM = {
        ...
        REG_SERVO_OUTPUT(4), REG_SERVO_OUTPUT(5),  
...
uint8_t servoTarget[NUM_SERVOS];
  ...
  uint8_t iopin[NUM_IO] = {2,3,4,7,8,9}; // Minima
#else
  uint8_t iopin[NUM_IO] = {3,4,5,6,7,8}; // Nano
#endif
