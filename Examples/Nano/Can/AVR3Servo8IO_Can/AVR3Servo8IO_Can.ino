...
/*
This is my test version for demonstration CAN Bus use only by John Holmes 3 Servo 8 I/O
  ...
  - Pins 3,4,5,6,7,8,9,A1 are used for input or output
...
#define MODEL "AVR3Servo8IO"  // The model of the board
#define HWVERSION "0.1"       // Hardware version
#define SWVERSION "0.1"       // Software version

// To set a new nodeid edit the next line
#define NODE_ADDRESS  5,1,1,1,0x8E,0x03 //Node 1
...
#else
  uint8_t iopin[NUM_IO] = {3,4,5,6,7,8,9,A1}; // Nano
#endif
...
{ 
  ...
  NODECONFIG.put(EEADDR(nodeDesc), ESTRING("3Servos8IO"));
