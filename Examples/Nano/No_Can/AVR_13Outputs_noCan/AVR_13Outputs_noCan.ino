/* AVR 13-Output Node 
   ...
   N Action eventids
   each:
   -- pin number from 3,4,5,6,7,8,9,A0,A1,A2,A3,A4,A5
   -- Actions from: Low, High, Flash, Double Strobe, Random, Fire, FireOff
...
#define NUM_ACTION_SETS 4   // number of action sets
#define NUM_APS 10     // number of actions per sets
#define NUM_CHANNEL 13 // number of pins
#define NUM_ACTION 40  // number of events/actions
  ...
  <group replication=')" N(NUM_APS) R"('>
    ...
    <int size="1"><name>pin#</name>
        <map>
          ...
          <relation><property>8</property><value>A0</value></relation>
          <relation><property>9</property><value>A1</value></relation>
          <relation><property>10</property><value>A2</value></relation>
          <relation><property>11</property><value>A3</value></relation>
          <relation><property>12</property><value>A4</value></relation>
          <relation><property>13</property><value>A5</value></relation>
        </map>
    </int>
...
// USER defined
uint8_t pin[NUM_CHANNEL] = { 3,4,5,6,7,8,9,A0,A1,A2,A3,A4,A5 };  // 13 channel
...
void userInitAll() {
  ...
  NODECONFIG.put(EEADDR(nodeDesc), ESTRING("13 outputs"));
