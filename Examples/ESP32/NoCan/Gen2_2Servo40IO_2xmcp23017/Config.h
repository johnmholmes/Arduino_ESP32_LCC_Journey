...
#define NUM_EVENT ( (NUM_SERVOS * NUM_POS) + ( (NUM_NATIVE_IO + NUM_MCP_IO) *2 ) ) 
...
#define MODEL BOARD "2Servo40IO" // The model of the board
...
// If NUM_SERVOS>8 or NUM_IO>40 these will need extending
