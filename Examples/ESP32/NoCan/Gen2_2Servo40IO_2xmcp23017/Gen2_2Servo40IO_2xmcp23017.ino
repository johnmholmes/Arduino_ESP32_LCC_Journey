...
extern "C" {
    ...
    const EIDTab eidtab[NUM_EVENT] PROGMEM = {
        ...
        //REG_MCP(NUM_NATIVE_IO), REG_MCP(NUM_NATIVE_IO+8), REG_MCP(NUM_NATIVE_IO+16), REG_MCP(NUM_NATIVE_IO+24), 
...
{ 
  ...
  NODECONFIG.put(EEADDR(nodeDesc), ESTRING("2Servos2MCP"));
    ...
    switch (type) {  // No PULLUP
      ...
      case 7: case 8: case 9: case 10:
        ...
        if(i<NUM_NATIVE_IO) digitalWrite(iopin[i], !type&1);
          ...
          uint8_t ch = i-NUM_NATIVE_IO;
          if(ch<16) mcp1.digitalWrite(ch, !type&1);
          else mcp2.digitalWrite(ch-16, !type&1);
        }
        break;
    }
...
void setup()
{
    ...
    dP("\n mcp23017-1 address = "); dP(MCP_ADDRESS1);
    dP("\n mcp23017-2 address = "); dP(MCP_ADDRESS2);
