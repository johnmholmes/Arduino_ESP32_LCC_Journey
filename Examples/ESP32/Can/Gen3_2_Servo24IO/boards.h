...
#include "Config.h"
  ...
  #define NUM_IO        27    // calcualte by hand = 11+16
  #ifndef USEGCSERIAL
  ...
  #define IOPINS        22,19
  #define NUM_IO        18    // calcualte by hand = 2+16
...
#elif defined(ATOM_BOARD_WITH_BASE)
  #define BOARD "Atom"
  //#define NUM_SERVOS 2
  #define SERVOPINS     23,33
  #define NUM_NATIVE_IO 1
  #define IOPINS        39 // button
  #define NUM_IO        17    // calcualte by hand = 1+16
  ...
  //#define EEPROMbegin { dP("\n size of memstruct="); dP(sizeof(MemStruct)); if(!EEPROM.begin(sizeof(MemStruct)+100)) { Serial.println("Failed to initialize EEPROM"); }
  #define EEPROMcommit { EEPROM.commit(); dP("EEPROM COMMIT"); }
  #define WIRE_begin Wire.begin(26, 32, 100000)  // choose pins for I2C
  ...
  #define NUM_IO        24    // calculate by hand = 8+16
  #define CAN_TX_PIN 4
  #define CAN_RX_PIN 5
  #ifndef USEGCSERIAL
    #include "R4.h"
