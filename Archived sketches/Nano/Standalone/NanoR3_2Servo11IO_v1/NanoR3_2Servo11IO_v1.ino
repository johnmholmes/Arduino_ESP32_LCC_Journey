...
This is my test version for demonstration Standalone use only by John Holmes 1 Servo 12 I/O
  ...
  - Pins 3,4,5,6,7,8,9,A0,A1,A2,A3 are used for input or output
  - Pins A4,A5 servos
...
#define MODEL "NanoR3_2Servo11IO"  // The model of the board
...
extern "C" {
    ...
    const EIDTab eidtab[NUM_EVENT] PROGMEM = {
        ...
        REG_IO(6), REG_IO(7),REG_IO(8), REG_IO(9), REG_IO(10),  
    };
...
uint8_t servoTarget[NUM_SERVOS];
  ...
  uint8_t iopin[NUM_IO] = {2,3,4,6,6,8,9,A0,A1,A2,A3}; // Minima
#else
  uint8_t iopin[NUM_IO] = {3,4,5,6,7,8,9,A0,A1,A2,A3}; // Nano
#endif
...
{ 
  ...
  NODECONFIG.put(EEADDR(nodeDesc), ESTRING("2 Servos 11 IO"));
