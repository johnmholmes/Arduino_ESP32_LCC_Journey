...
#define MODEL "AVR3Servo10IO"  // The model of the board
...
void userInitAll()
{ 
  NODECONFIG.put(EEADDR(nodeName), ESTRING("NanoR3"));
  NODECONFIG.put(EEADDR(nodeDesc), ESTRING("3Servos10IO"));
